	...
	return (
		<div className="container mx-[9rem]">
			<div className="flex flex-col md:flex-row">
				<div className="p-3">
					<div className="ml-[2rem] text-xl font-bold h-12">All Products ({data?.products?.length})</div>
					...
					<div className="flex flex-wrap justify-around items-center">
						{data?.products?.map((product, index) => {
							return (
								<Link
									key={index}
									to={`/admin/create-product/update/${product._id}`}
									...
									<div className="flex">
										...
										<div className="p-4 flex flex-col justify-around">
											<div className="flex justify-between">
												<h5 className="text-xl font-semibold mx-2">{product.name}</h5>
